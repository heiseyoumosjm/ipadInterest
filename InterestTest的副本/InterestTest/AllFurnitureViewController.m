...
@interface AllFurnitureViewController ()<UITableViewDataSource,UITableViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation AllFurnitureViewController
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    NSMutableDictionary *dic=[[NSMutableDictionary alloc]init];
    dic=_dataArr[indexPath.row];
    FurnitureCategoryViewController *good=[[FurnitureCategoryViewController alloc]init];
