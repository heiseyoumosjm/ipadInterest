...
- (void)initialization
{
    ...
    _currentPageDotColor = [UIColor colorWithRed:195.0/255.0 green:13.0/255.0 blue:35.0/255.0 alpha:1.0];
...
//    CGFloat y = self.mainView.sd_height - size.height - 10;
    ...
    self.pageControl.frame = CGRectMake(x, self.mainView.sd_height-30, size.width, 2);
